...
<div class="documentation--container">
    <div class="documentation--wrap">
        <div class="container">
            ...
            <code class="language-markup">/api/authors/{id}</code> <br>
                ...
                <code>
{
  ...
  "author": {
    ...
    "updated_at": "2016-11-12 17:52:44"
            ...
            <p>The author will be automatically stored as an entry. If there is already an author with the same name, it will be appended to their list of quotes.</p>
            <br>
